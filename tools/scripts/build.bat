...
mkdir "run"
echo D | xcopy /Q /Y ".\build\release\PVFDefaultEvents.dll" ".\run\SKSE\Plugins"
echo D | xcopy /Q /Y ".\build\release\PVFDefaultEvents.pdb" ".\run\SKSE\Plugins"
...
if "%GITHUB_ACTIONS%" NEQ "true" (
    ...
    mklink /J "!MODS_DIR!\PlayerVoiceFramework - Default Events" "run"
    if errorlevel 1 (
